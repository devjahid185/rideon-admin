            ...
            @can('booking_access')
                <li class="treeview {{ request()->is('admin/bookings*') ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ request()->is('admin/food-orders') || request()->is('admin/food-orders/*') ? 'active' : '' }}">
                        ...
                        <li class="treeview {{ request()->is('admin/food-catalog') || request()->is('admin/food-catalog/*') ? 'active' : '' }}">
                            ...
                            <ul class="treeview-menu">
                                <li class="{{ request()->is('admin/food-catalog/restaurants') ? 'active' : '' }}">
                                    <a href="{{ route('admin.food-catalog.restaurants.index') }}">
                                        <i class="fas fa-dot-circle"></i>
                                        <span>Restaurants</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('admin/food-catalog/branches') ? 'active' : '' }}">
                                    <a href="{{ route('admin.food-catalog.branches.index') }}">
                                        <i class="fas fa-dot-circle"></i>
                                        <span>Branches</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('admin/food-catalog/categories') ? 'active' : '' }}">
                                    <a href="{{ route('admin.food-catalog.categories.index') }}">
                                        <i class="fas fa-dot-circle"></i>
                                        <span>Categories</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('admin/food-catalog/items') || request()->is('admin/food-catalog/items/*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.food-catalog.items.index') }}">
                                        <i class="fas fa-dot-circle"></i>
                                        <span>Items</span>
                                    </a>
                                </li>
